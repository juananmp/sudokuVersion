...
public class FiltroReintentos implements Filter {
    ...
    public FiltroReintentos() {
    }    
    
    private void doBeforeProcessing(ServletRequest request, ServletResponse response)
            throws IOException, ServletException {
        if (debug) {
            log("FilterReintentos:DoBeforeProcessing");
        }
    ...
    private void doAfterProcessing(ServletRequest request, ServletResponse response)
            throws IOException, ServletException {
        if (debug) {
            log("FilterReintentos:DoAfterProcessing");
        }
    ...
    public void doFilter(ServletRequest request, ServletResponse response,
      ...
      hitCount++;
       System.out.println(hitCount+"fuera del if<<<<<<<<<<<<<<<<<<<<<<<<<<");
        ...
        {
            System.out.println(hitCount+"dentro del chain<<<<<<<<<<<<<<<<<<<<");
    ...
    public String toString() {
        if (filterConfig == null) {
            return ("FilterReintentos()");
        }
        StringBuffer sb = new StringBuffer("FilterReintentos(");
